...
CCGIFEncoder.prototype.add=function(a){this.sizeSet||(this.encoder.setOption("width",a.width),this.encoder.setOption("height",a.height),this.sizeSet=!0);this.canvas.width=a.width;this.canvas.height=a.height;this.ctx.drawImage(a,0,0);this.encoder.addFrame(this.ctx,{copy:!0,delay:this.settings.step})};CCGIFEncoder.prototype.save=function(a){this.encoder.on("finished",function(c){a(URL.createObjectURL(c))});this.encoder.on("progress",function(a){console.log(a)});this.encoder.render()};
